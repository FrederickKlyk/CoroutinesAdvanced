...
import de.klyk.coroutinesadvanced.ui.paging.MoviePagingFragmentViewModel
...
val viewModelModule = module {
    ...
    viewModel { MoviePagingFragmentViewModel(movieDatabase = get(), getMoviesFlowRepository = get()) }
}